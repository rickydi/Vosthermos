...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: { canonical: `https://www.vosthermos.com/en/prix/${pricing.slug}` },
  };
}
      ...
      <div className="bg-[var(--color-teal-dark)] py-14">
        <div className="max-w-[900px] mx-auto px-6">
          <div className="flex flex-wrap items-center gap-2 text-white/40 text-sm mb-4">
            <Link href="/en/prix" className="hover:text-white transition-colors">Pricing</Link>
            <span>/</span>
            <span className="text-white/60">{pricing.title}</span>
          </div>
          <h1 className="text-3xl md:text-4xl font-extrabold text-white mb-4">
            How much does it cost: {pricing.title.toLowerCase()}
          </h1>
          ...
          <div className="lg:col-span-2 space-y-12">
            ...
            <div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="bg-gray-50">
                      ...
                      <th className="text-right px-5 py-3 text-sm font-semibold text-gray-700">Price</th>
                    </tr>
                  </thead>
                  <tbody>
              ...
              <p className="text-xs text-gray-400 mt-3">
                * Prices shown for reference, taxes extra. Free quote with no obligation for an exact price.
              </p>
            </div>
                    ...
                    <thead>
                      <tr className="bg-[var(--color-teal-dark)] text-white">
                        ...
                        <th className="text-center px-5 py-3 text-sm font-semibold">
                          <i className="fas fa-check mr-1"></i> Repair
                        </th>
                        <th className="text-center px-5 py-3 text-sm font-semibold">Full replacement</th>
                      </tr>
                    </thead>
                    <tbody>
            ...
            {pricing.savings && (
              <div className="bg-green-50 border border-green-200 rounded-xl p-6 flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-green-800 mb-1">Real savings</h3>
            ...
            <div className="bg-gradient-to-r from-[var(--color-teal-dark)] to-[var(--color-teal)] rounded-2xl p-8 text-white">
              <h3 className="text-xl font-bold mb-3">
                ...
                Need multiple repairs? OPTI-FENETRE Program
              </h3>
              <p className="text-white/70 mb-4 text-sm">
                Bundle sealed units, hardware, weatherstripping, caulking and screens into a single package.
                Up to 70% savings vs. full replacement.
              </p>
            ...
            {/* FAQ */}
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-6">Frequently asked questions about pricing</h2>
              <div className="space-y-4">
            ...
            <div className="bg-gray-50 rounded-2xl p-6 sticky top-[100px] space-y-6">
              <div>
                ...
                <p className="text-gray-500 text-sm mb-4">
                  Get an exact price for your project. No obligation.
                </p>
              ...
              {service && (
                <div className="pt-4 border-t border-gray-200">
                  <h3 className="font-bold text-gray-900 mb-3">Related service</h3>
                  <Link href={`/en/services/${service.slug}`} className="flex items-center gap-3 p-3 bg-white rounded-xl hover:shadow-md transition-all group">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-400">Service details &rarr;</p>
                    </div>
                  </Link>
                </div>
              )}
              ...
              <div className="pt-4 border-t border-gray-200">
                <h3 className="font-bold text-gray-900 mb-3">Other pricing guides</h3>
                <div className="space-y-2">
                  {otherPricing.map((p) => (
                    <Link key={p.slug} href={`/en/prix/${p.slug}`} className="block text-sm text-gray-600 hover:text-[var(--color-teal)] transition-colors py-1">
                      {p.title}
                    </Link>
                  ))}
                </div>
