...
export default async function HomeEn() {
  ...
  return (
    <>
      ...
      {/* Hero -- Shop catalogue */}
      <section className="bg-[var(--color-background)] pt-[65px]">
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="rounded-xl overflow-hidden shadow-sm border border-[var(--color-border)]">
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d44818.60183345312!2d-73.45735594648!3d45.37106269649143!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4cc90fb925e4b0c3%3A0x18bb6483b7f0b8b0!2sDelson%2C%20QC!5e0!3m2!1sen!2sca!4v1712977261056!5m2!1sen!2sca"
                width="100%"
                height="100%"
