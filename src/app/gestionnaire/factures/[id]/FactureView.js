    ...
    <div>
      ...
      >
          ...
          <div>
            ...
            {wo.dueDate && isInvoice && (
              <div style={{ fontSize: 11, color: "rgba(255,255,255,0.7)", marginTop: 2 }}>
                Echeance : {new Date(wo.dueDate).toLocaleDateString("fr-CA", { day: "numeric", month: "long", year: "numeric" })} - Net {wo.paymentTermsDays} jours
              </div>
            )}
          </div>
        </div>
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <a
            href={`/api/manager/work-orders/${wo.id}/pdf?documentType=invoice`}
          ...
          >
            <i className="fas fa-download" style={{ marginRight: 6 }}></i>Telecharger PDF
          </a>
        </div>
      </div>
