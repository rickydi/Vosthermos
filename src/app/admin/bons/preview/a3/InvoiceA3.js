    ...
    <div className="bg-neutral-200 min-h-screen py-6 print:py-0 print:bg-white">
      <style jsx global>{`
        @media print {
          ...
          .invoice-section, .invoice-totals, .invoice-footer { break-inside: avoid; }
      ...
      <div className="max-w-5xl mx-auto px-4 mb-4 flex items-center justify-between print:hidden">
        <Link href={backHref} className="text-neutral-600 text-sm hover:text-neutral-900 font-medium">
      ...
      <div className="bg-white mx-auto shadow-[0_20px_60px_rgba(0,0,0,0.15)] print:shadow-none"
        ...
        {/* Sections B2B — outlined red badges */}
        ...
        <div className="invoice-totals px-14 pb-8 flex justify-end">
        ...
        {/* Footer */}
        <div className="invoice-footer px-14 py-6 border-t border-neutral-200 bg-neutral-50">
