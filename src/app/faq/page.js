    ...
    items: [
      {
        ...
        answer:
          "Nous offrons une garantie de 10 ans sur tous nos remplacements de vitres thermos, transférable au prochain propriétaire, qui couvre les défauts de fabrication et la perte d'étanchéité de l'unité scellée. La main-d'œuvre est quant à elle garantie 5 ans. Pour les autres services comme le remplacement de quincaillerie et la fabrication de moustiquaires, la durée de la garantie varie selon le type de pièce et de travail effectué. Les détails spécifiques de la garantie sont toujours inclus dans votre soumission écrite avant le début des travaux.",
      },
      {
