...
function ContactContent() {
  ...
  // Heures lues dans /admin/parametres (via useCompany), plus jamais ecrites
  // en dur : le texte visible et le JSON-LD de cette page se contredisaient.
  const hours = hoursByDay(COMPANY_INFO, "fr");
