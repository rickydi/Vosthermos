...
export const CITY_SERVICE_SEO = {
  "remplacement-vitre-thermos": {
    ...
    description: (c) => `Thermos embué à ${c.name}? Vosthermos remplace vos vitres dès 150$. ✓ Garantie 10 ans ✓ Soumission gratuite 24h ✓ 15 ans d'expérience ☎ 514-825-8411`,
  },
  ...
  "moustiquaires-sur-mesure": {
    ...
    description: (c) => `Moustiquaire déchirée à ${c.name}? Vosthermos fabrique sur mesure en 48h. Toutes dimensions, tous modèles. Soumission gratuite ☎ 514-825-8411`,
  },
  "calfeutrage": {
    title: (c) => `Calfeutrage Fenêtres ${c.name} • Étanchéité Garantie`,
    description: (c) => `Courants d'air à ${c.name}? Vosthermos calfeutre vos fenêtres et portes. Moins de chauffage, plus de confort. 15 ans d'expérience ☎ 514-825-8411`,
  },
  "desembuage": {
    title: (c) => `Désembuage Vitres ${c.name} • 50% Moins Cher`,
    description: (c) => `Vitres thermos embuées à ${c.name}? Alternative au remplacement: désembuage dès 80$. Résultat durable et garanti ☎ 514-825-8411`,
  },
  "insertion-porte": {
    title: (c) => `Insertion de Porte ${c.name} • Nouvelle Porte 1 Jour`,
    description: (c) => `Nouvelle porte sans refaire le cadre à ${c.name}? Vosthermos installe l'insertion en 1 jour. Économies de 40% vs remplacement ☎ 514-825-8411`,
  },
  "coupe-froid": {
    title: (c) => `Coupe-froid Fenêtres ${c.name} • Fin des Courants d'air`,
    description: (c) => `Courants d'air, perte de chaleur à ${c.name}? Vosthermos remplace vos coupe-froids usés. Économisez sur le chauffage ☎ 514-825-8411`,
  },
};
...
export function getServiceSeo(serviceSlug, city, fallbackShortTitle) {
  ...
  return {
    ...
    description: `${fallbackShortTitle} à ${city.name}, ${city.region}. Service professionnel Vosthermos. 15 ans d'expérience, soumission gratuite 24h ☎ 514-825-8411`,
  };
}
...
export const CITY_PAGE_SEO = {
  "reparation-portes-et-fenetres": {
    ...
    description: (c) => `Thermos embué, porte bois, quincaillerie à ${c.name}? Vosthermos répare tout en 24-48h. 740+ pièces en stock, 15 ans d'expérience ☎ 514-825-8411`,
  },
  "calfeutrage": {
