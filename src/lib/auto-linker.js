...
const SERVICE_KEYWORDS = [
  { keywords: ["reparation de portes et fenetres chateauguay", "reparation portes et fenetres chateauguay", "reparation porte et fenetre chateauguay", "portes et fenetres chateauguay", "porte et fenetre chateauguay"], url: "/reparation-portes-et-fenetres/chateauguay", title: "Reparation de portes et fenetres Chateauguay" },
  ...
  { keywords: ["remplacement vitre thermos montreal", "remplacement de vitre thermos montreal", "remplacement thermos montreal", "remplacement de thermos montreal", "vitre thermos montreal", "vitre thermos a montreal"], url: "/services/remplacement-vitre-thermos/montreal", title: "Remplacement vitre thermos Montreal" },
  { keywords: ["quincaillerie fenetre montreal", "quincaillerie de fenetre montreal", "remplacement quincaillerie fenetre montreal", "remplacement de quincaillerie fenetre montreal", "manivelle fenetre montreal", "poignee fenetre montreal", "serrure fenetre montreal"], url: "/services/remplacement-quincaillerie/montreal", title: "Quincaillerie fenetre Montreal" },
  ...
  { keywords: ["reparation porte-fenetre montreal", "reparation porte fenetre montreal", "reparation de porte-fenetre montreal", "porte-fenetre montreal", "porte francaise montreal"], url: "/services/reparation-porte-fenetre/montreal", title: "Reparation porte-fenetre Montreal" },
  { keywords: ["calfeutrage fenetre montreal", "calfeutrage de fenetre montreal", "calfeutrage exterieur montreal", "calfeutrage montreal"], url: "/services/calfeutrage/montreal", title: "Calfeutrage fenetre Montreal" },
  { keywords: ["coupe-froid fenetre montreal", "coupe froid fenetre montreal", "remplacement coupe-froid montreal", "joint fenetre montreal", "infiltration air fenetre montreal"], url: "/services/coupe-froid/montreal", title: "Coupe-froid fenetre Montreal" },
  { keywords: ["moustiquaire fenetre montreal", "moustiquaire montreal", "moustiquaire sur mesure montreal", "reparation moustiquaire montreal", "moustiquaire porte patio montreal"], url: "/services/moustiquaires-sur-mesure/montreal", title: "Moustiquaire fenetre Montreal" },
  { keywords: ["reparation fenetre bois montreal", "reparation fenetre en bois montreal", "restauration fenetre bois montreal", "cadre fenetre bois montreal", "bois pourri fenetre montreal"], url: "/services/reparation-portes-bois/montreal", title: "Reparation fenetre bois Montreal" },
