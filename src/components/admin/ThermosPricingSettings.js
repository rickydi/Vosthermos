...
const FIELDS = [
  ...
  { key: "thermos_grill_per_unit", label: "Carreaux décoratifs par thermos", suffix: "$" },
  { key: "thermos_spacer_option_per_unit", label: "Intercalaire couleur speciale", suffix: "$" },
  { key: "thermos_nonstandard_thickness_per_unit", label: "Epaisseur autre que 13/16", suffix: "$" },
  { key: "thermos_access_medium_per_unit", label: "Acces moyen", suffix: "$" },
  { key: "thermos_access_hard_per_unit", label: "Avec échelle", suffix: "$" },
